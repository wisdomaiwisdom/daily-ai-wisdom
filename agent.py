...
"5. Write the post. MANDATORY: Use MODE 1 harsh reality today.\n"
                "   The hook must be unexpected and specific — not generic.\n"
                "   FORBIDDEN openings: 'Most leaders', 'Most people', 'The best leaders'\n"
                "   REQUIRED: Start with something nobody expects. Like:\n"
                "   'Trees can move. You cannot. Wait — that is backwards.'\n"
                "   'Your calendar is an autobiography. Most people hate theirs.'\n"
                "   'The meeting you dread most is the one you need to have.'\n"
                "   Make it specific, logical, slightly dark, and impossible to ignore.\n\n"                "IMPORTANT: Output ONLY the post. "
